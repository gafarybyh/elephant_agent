...
(function (factory) {
    ...
    $.extend(FixedHeader.prototype, {
        ...
        _clone: function (item, force) {
            ...
            var itemElement =
                item === "header" ? this.dom.thead : this.dom.tfoot;
        ...
        _stickyPosition: function (el, sign) {
            if (this._scrollEnabled()) {
                var that = this;
                var rtl =
                    $(that.s.dt.table().node()).css("direction") === "rtl";
        ...
        _modeChange: function (mode, item, forceChange) {
            ...
            var importantWidth = function (w) {
                itemDom.floating[0].style.setProperty(
                    "width",
                    w + "px",
                    "important"
                );
                ...
                if (!scrollEnabled) {
                    itemDom.floatingParent[0].style.setProperty(
                        "width",
                        w + "px",
                        "important"
                    );
            ...
            if (
                ...
                if (scrollEnabled && footer.offset.top > windowTop) {
                    ...
                    if (
                        ...
                        $(this.dom.tfoot.parent()).addClass(
